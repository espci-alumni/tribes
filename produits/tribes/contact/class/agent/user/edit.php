...
class agent_user_edit extends agent_pForm
{
    ...
    function control()
    {
        ...
        $this->data += $this->contact->fetchRow('contact_id, login, contact_confirmed, admin_confirmed, contact_modified, photo_token, cv_token, acces, contact_data');
    ...
    {
        if (!empty($this->data->login) && (!empty($CONFIG['tribes.emailDomain']) || $this->confirmed))
        {
